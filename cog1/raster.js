           ...
           function drawLineBresenham(startX, startY, startZ, endX, endY, endZ, color, storeIntersectionForScanlineFill, edgeStartVertexIndex, edgeEndVertexIndex, edgeStartTextureCoord, edgeEndTextureCoord) {
               ...
               // y is driving variable.
                   ...
                   while (y != endY) {
                       ...
                       // console.log(storeIntersectionForScanlineFill);
        ...
        function assembleIntersectionForScanline(vertices, polygon, color, textureCoord, polygonTextureCoord, texture) {
            ...
            for (var v = polygon.length - 1; v > 0; v--) {
              startPoint = vertices[polygon[v]];
               endPoint = vertices[polygon[lastIndex]];
            ...
            for (var v = 0; v < polygon.length; v++) {
               ...
               var edgeStartVertexIndex = polygon[v];
               startPoint = vertices[edgeStartVertexIndex];
                // Connect edge to next or to first vertex to close the polygon.
               var nextVertexIndex = (v < polygon.length-1)?v+1:0;
               var edgeEndVertexIndex = polygon[nextVertexIndex];
               endPoint = vertices[edgeEndVertexIndex];
               ...
               // Convert parameters to integer values.
                ...
                if(texture != null) {
                    var edgeStartTextureCoord = textureCoord[polygonTextureCoord[v]];
                    var edgeEndTextureCoord = textureCoord[polygonTextureCoord[nextVertexIndex]];
                }

                drawLineBresenham(currX, currY, currZ, nextX, nextY, nextZ, color, true ,
                    edgeStartVertexIndex, edgeEndVertexIndex, edgeStartTextureCoord,  edgeEndTextureCoord);
               ...
               // lastDerivative = derivative;
                ...
                addIntersection(nextX,nextY,nextZ,1.0, edgeStartVertexIndex,edgeEndVertexIndex,edgeStartTextureCoord,edgeEndTextureCoord);
                ...
                if (derivative + lastDerivative == 0) {
                    addIntersection(currX, currY, currZ, 0.0, edgeStartVertexIndex, edgeEndVertexIndex, edgeStartTextureCoord, edgeEndTextureCoord);
                }
        ...
        function scanlineFillPolygon(vertices, polygon, color, textureCoord, polygonTextureCoord, texture) {
          ...
          for (var y = 0; y < height; y++) {
              ...
              for (var i = 0; i < scanlineIntersection[y].length-1; i+=2){
                  var x1 = scanlineIntersection[y][i];
                  var x2 = scanlineIntersection[y][i+1];
